...
var _user$project$Card$init = {ctor: '_Tuple2', _0: 3, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Card$Decrement = {ctor: 'Decrement'};
var _user$project$Card$Increment = {ctor: 'Increment'};
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Events$onClick(_user$project$Card$Decrement)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Events$onClick(_user$project$Card$Increment)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
...
var Elm = {};
Elm['Card'] = Elm['Card'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Card'], 'Card', typeof _user$project$Card$main === 'undefined' ? null : _user$project$Card$main);
